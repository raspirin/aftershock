...
use crate::{
    app::{components::{ContentSerif, MessageBox, ProseContent}, server::get_page}, MSG_DATA_NOT_FOUND,
};
    ...
    view! { 
        ...
        {match data {
            Some(page) => {
                ...
                Either::Right(view! { <ContentSerif><ProseContent body=body /></ContentSerif> })},
